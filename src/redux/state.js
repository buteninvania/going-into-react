import {rerednerIntireThree} from "../render";
...
let state = {
    ...
    messagePage: {
        ...
        dialogData: [{
            name: "Vitalik",
            id: 1,
            urlImg: "https://sun9-14.userapi.com/c855128/v855128037/1c553e/WT0UFN-xILI.jpg?ava=1"
        },
...
export let addMessage = () => {
    let newMessage = {message: state.messagePage.newMessageText };
    state.messagePage.messageData.push(newMessage);
    updateMessageChange("");
    rerednerIntireThree(state);
}

export let updateMessageChange = (newText) => {
